package com.zsanjay.bank.cards.controller;

import com.zsanjay.bank.cards.constants.CardsConstants;
...
import com.zsanjay.bank.cards.dto.ResponseDto;
import com.zsanjay.bank.cards.service.CardsService;
...
public class CardsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Card inside Bank service"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
